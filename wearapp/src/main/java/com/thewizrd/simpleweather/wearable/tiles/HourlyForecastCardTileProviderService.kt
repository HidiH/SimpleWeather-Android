...
import com.thewizrd.simpleweather.wearable.tiles.layouts.hourlyForecastCardTileLayout
import com.thewizrd.weather_api.weatherModule
import java.time.ZonedDateTime
import java.time.temporal.ChronoUnit

class HourlyForecastCardTileProviderService : WeatherCoroutinesTileService() {
    companion object {
        private const val TAG = "HourlyForecastCardTileProviderService"
        private const val MAX_FORECAST_LENGTH = 4
    }
    ...
    override fun renderTile(
        ...
        return hourlyForecastCardTileLayout(weather, this, requestParams)
    }
