...
import com.thewizrd.simpleweather.widgets.WeatherWidgetProvider4x2M3
...
class WeatherWidget4x2M3Creator(context: Context) : WidgetRemoteViewCreator(context) {
    private fun generateRemoteViews(): RemoteViews {
        return RemoteViews(context.packageName, R.layout.app_widget_4x2_m3)
    }

    override val info: WidgetProviderInfo
        get() = WeatherWidgetProvider4x2M3.Info.getInstance()
